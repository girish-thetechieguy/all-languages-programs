...
public class _11_AssertionsDemoTest {
    private final _02_Calculator calculator = new _02_Calculator();

    private final _08_Person person = new _08_Person("Jane", "Doe");
    ...
    void timeoutNotExceededWithMethod() {
        ...
        String actualGreeting = assertTimeout(ofMinutes(2), _11_AssertionsDemoTest::greeting);
