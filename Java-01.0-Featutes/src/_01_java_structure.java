...
public class _01_java_structure {
    public static void main(String[] args) { // the entry point of the program. The JVM looks for this method to start execution.
        System.out.println("Hi all! Welcome to My java world!");
    }
}
